                ...
                if (device.getBondState() == BluetoothDevice.BOND_BONDED) {    //显示已配对设备
                    ...
                    if (device.getAddress().equals(mac)) {
                        ...
                        if(textViewCounter == 5) {
                            ...
                            DatabaseReference mRSSI10 = mDatabase10.child("beaconPhone");
                            mRSSI10.addValueEventListener(new ValueEventListener() {
                                @Override
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    if(dataSnapshot.hasChild(mac)){
                                        Intent myIntent = new Intent(calibration.this, MapsActivity.class);
                                        calibration.this.startActivity(myIntent);
                                    } else {
                                        Intent myIntent = new Intent(calibration.this, phoneNumber.class);
                                        calibration.this.startActivity(myIntent);
                                    }
                                }
                                @Override
